...
const LOCAL_CATEGORIES: LocalCategory[] = [
  ...
  { name: "UI/UX", slug: "ui-and-ux", iconName: "design_services" },
  { name: "프로그래밍 언어", slug: "프로그래밍-언어", iconName: "code" },
  { name: "IT 교양", slug: "IT-교양", iconName: "school" },
  { name: "운영체제", slug: "운영체제", iconName: "memory" },
];

export default LOCAL_CATEGORIES;
